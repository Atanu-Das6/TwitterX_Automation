...
public class Love_New_Acoount {
    public WebDriver webDriver;
    public  String string;
    public Properties properties;
    public PageElements_Like pageElementsLike;
    ...
    void Love(String string,String s) throws InterruptedException {
        ...
        pageElementsLike = new PageElements_Like(webDriver);
        pageElementsLike.Like_karo();
    }
    @AfterClass
    void  End_session() throws IOException {
        ...
        ImageIO.write(Screenshot.getImage(), "jpg", new File(System.getProperty("user.dir")+"\\screenshots\\fullscreenLove.jpg"));
