...
public class Follw_New_Account {
    public WebDriver webDriver;
    public  String string;
    public Properties properties;
    public PageElements_Follw pageElementsShare;
    ...
    void Follow(String string,String s) throws InterruptedException {
        ...
        pageElementsShare = new PageElements_Follw(webDriver);
        pageElementsShare.Share_karo();
    }
    @AfterClass
    void  End_session() throws IOException {
        ...
        ImageIO.write(Screenshot.getImage(), "jpg", new File(System.getProperty("user.dir")+"\\screenshots\\fullscreenFollw.jpg"));
