...
public class RepostingQ_New_Account {
    public WebDriver webDriver;
    public  String string;
    public Properties properties;
    public  PageElements_SignInAccount pageElementsSignInAccount;
    public  PageElememts_RepostQ pageElememtsRepostQ;
    @BeforeClass()
    ...
    void RepostingQ(String string,String s) throws InterruptedException {
        ...
        pageElememtsRepostQ = new PageElememts_RepostQ(webDriver);
        pageElememtsRepostQ.Reposting(s);
    }
    @AfterClass
    void  End_session() throws IOException {
        ...
        ImageIO.write(Screenshot.getImage(), "jpg", new File(System.getProperty("user.dir")+"\\screenshots\\fullscreenREPOSTQ.jpg"));
