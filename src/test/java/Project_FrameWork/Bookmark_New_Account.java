...
public class Bookmark_New_Account {

    public WebDriver webDriver;

    public  String string;
    public Properties properties;
    public PageElements_Bookmark pageElementsBookmark;
    ...
    void Bookmark(String string,String s) throws InterruptedException {
        ...
        pageElementsBookmark = new PageElements_Bookmark(webDriver);
        pageElementsBookmark.Bookmark_karo();
    }
    @AfterClass
    void  End_session() throws IOException {
        ...
        ImageIO.write(Screenshot.getImage(), "jpg", new File(System.getProperty("user.dir")+"\\screenshots\\fullscreenBook.jpg"));
