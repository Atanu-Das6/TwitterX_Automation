...
public class Unfollow_New_Account {
    public WebDriver webDriver;
    public  String string;
    public Properties properties;
    public PageElements_UnFollw pageElementsUnFollw;
    ...
    public void Unfollow(String string,String s) throws InterruptedException  {
        ...
        pageElementsUnFollw = new PageElements_UnFollw(webDriver);
        pageElementsUnFollw.UnFollow_karo();
    ...
    void  End_session() throws IOException {
        ...
        ImageIO.write(Screenshot.getImage(), "jpg", new File(System.getProperty("user.dir")+"\\screenshots\\fullscreenUnFollw.jpg"));
