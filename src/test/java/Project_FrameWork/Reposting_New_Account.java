...
public class Reposting_New_Account {
    public WebDriver webDriver;
    public  String string;
    public Properties properties;
    public  PageElements_SignInAccount pageElementsSignInAccount;
    public  PageElements_Repost pageElementsRepost;
    @BeforeClass()
    ...
    void Reposting(String string,String s) throws InterruptedException {
        ...
        pageElementsRepost = new PageElements_Repost(webDriver);
        pageElementsRepost.Reposting();
    }
    @AfterClass
    void  End_session() throws IOException {
        ...
        ImageIO.write(Screenshot.getImage(), "jpg", new File(System.getProperty("user.dir")+"\\screenshots\\fullscreenREPOST.jpg"));
