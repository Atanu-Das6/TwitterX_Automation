...
public class Block_new_Account {
    public WebDriver webDriver;
    public  String string;
    public Properties properties;
    public PageElements_Block pageElementsBlock;
    ...
    public void Block(String string,String s) throws InterruptedException  {
        ...
        pageElementsBlock = new PageElements_Block(webDriver);
        pageElementsBlock.Block_karo();
    ...
    void  End_session() throws IOException {
        ...
        ImageIO.write(Screenshot.getImage(), "jpg", new File(System.getProperty("user.dir")+"\\screenshots\\fullscreenblock.jpg"));
